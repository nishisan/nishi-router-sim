...
public class NRouterSimApp {
    ...
    public static void main(String[] args) {
         ...
         * Link scope
         */
        router1.addRouteEntry("10.10.10.10", null, null, router1.getInterfaceByName("ge0/0/0/1"));
         ...
         */
        router1.addRouteEntry("0.0.0.0/0", "192.168.0.2", "192.168.0.1", router1.getInterfaceByName("ge0/0/0/1"));
        
        /**
         * Rota Bem Especifica
         */
        router1.addRouteEntry("8.8.8.8/32", "192.168.4.254", "192.168.4.1", router1.getInterfaceByName("ge0/0/0/5"));
