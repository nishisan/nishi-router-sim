...
public class SimpleRouterExample {
    ...
    public static void main(String[] args) {
        ...
        router1.addStaticRouteEntry("192.168.8.1/32", "192.168.7.1").setMetric(10);                                                                // Rota mais especifica
        router1.addStaticRouteEntry("192.168.8.1/32", "192.168.6.1").setMetric(20);                                                                // Rota mais especifica
        ...
        if (route.isPresent()) {
             ...
             */
            System.out.println("192.168.8.2 is reacheable via");
            route.get().print();
        }
